...
<head>
    ...
    <style>
        ...
        body{font-family:Inter, Arial, sans-serif;background:var(--bg);padding:24px;color:#123;}
        .card{max-width:820px;margin:24px auto;background:var(--card);padding:22px;border-radius:12px;box-shadow:0 6px 20px rgba(18,50,35,0.06)}
        ...
        .box{flex:1;min-width:260px;background:#fbfffb;border:1px solid var(--accent-soft);padding:14px;border-radius:10px}
        label{display:block;margin-top:8px;font-weight:600;color:#123}
        input[type="password"], input[type="file"]{width:100%;padding:10px;margin-top:8px;border:1px solid #dfe; border-radius:8px;background:#fff}
        .help{font-size:0.9rem;color:var(--muted);margin-top:6px}
        .btn{display:inline-block;padding:10px 14px;background:var(--accent);color:#fff;border-radius:8px;border:none;cursor:pointer;margin-top:12px}
        .msg{padding:10px;border-radius:8px;margin-bottom:12px}
        .success{background:#e9f8ef;color:#0b603a}
        .error{background:#fff1f1;color:#8a1a1a}
        .readonly-field{font-weight:600;padding:8px 10px;border-radius:8px;background:#fbfffb;border:1px solid var(--accent-soft);display:inline-block}
...
<div class="card">
    <div class="top">
        <div>
            ...
            <?php else: ?>
                <div class="profile-pic" style="display:flex;align-items:center;justify-content:center;color:#fff;background:var(--accent);font-weight:700">
            ...
            <?php if (array_key_exists('icona_profila', $user)): ?>
                <form method="post" enctype="multipart/form-data" id="picForm">
                    ...
                    <div style="display:flex;gap:10px;align-items:center;">
                        ...
                        <button type="button" class="btn" style="background:#66b77a" onclick="document.getElementById('profile_pic').value=''">Prekliči</button>
                    </div>
                </form>
            <?php else: ?>
