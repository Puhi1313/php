...
--
-- Gostitelj: 127.0.0.1
-- Čas nastanka: 30. sep 2025 ob 09.52
...
(1, 121, 11, 'Statistika', 'Nredi naloge v ucbeniku 4-5', '2025-10-07 00:00:00', '2025-09-30 08:57:42', 'uploads/naloge/1759215462_Vaja 2 - Nup - Kajetan_Markič.docx');
...
(1, 1, 142, '2025-09-30 09:50:44', 'resitve:\r\n x = 6', 'uploads/oddaje/142_1_1759217282.docx', 'Oddano', NULL, NULL);
...
INSERT INTO `uporabnik` (`id_uporabnik`, `ime`, `priimek`, `email`, `geslo`, `vloga`, `kraj`, `icona_profila`, `prvi_vpis`) VALUES
(121, 'Helena', 'Viher', 'viher@sola.si', 'geslo', 'ucitelj', NULL, NULL, 1),
(122, 'Tajda', 'Remic', 'remic@sola.si', 'geslo', 'ucitelj', NULL, NULL, 1),
(123, 'Valentina', 'Hrastnik', 'hrastnik@sola.si', 'geslo', 'ucitelj', NULL, NULL, 1),
(124, 'Katja', 'Kolar', 'kolar@sola.si', 'geslo', 'ucitelj', NULL, NULL, 1),
(125, 'Rosana', 'Breznik', 'breznik@sola.si', 'geslo', 'ucitelj', NULL, NULL, 1),
(126, 'Eva', 'Boh', 'boh@sola.si', 'geslo', 'ucitelj', NULL, NULL, 1),
(127, 'Borut', 'Slemenšek', 'slemensek@sola.si', 'geslo', 'ucitelj', NULL, NULL, 1),
(128, 'Jaka', 'Koren', 'koren@sola.si', 'geslo', 'ucitelj', NULL, NULL, 1),
(129, 'Andraž', 'Pušnik', 'pusnik@sola.si', 'geslo', 'ucitelj', NULL, NULL, 1),
(130, 'Boštjan', 'Lubej', 'lubej@sola.si', 'geslo', 'ucitelj', NULL, NULL, 1),
(131, 'Matija', 'Lukner', 'lukner@sola.si', 'geslo', 'ucitelj', NULL, NULL, 1),
(132, 'Sara', 'Padarič', 'padaric@sola.si', 'geslo', 'ucitelj', NULL, NULL, 1),
(133, 'Ana', 'Novak', 'ana.novak@ucenec.si', 'test123', 'ucenec', NULL, NULL, 0),
(134, 'Marko', 'Kovač', 'marko.kovac@ucenec.si', 'test123', 'ucenec', NULL, NULL, 1),
(135, 'Tina', 'Horvat', 'tina.horvat@ucenec.si', 'test123', 'ucenec', NULL, NULL, 0),
(136, 'Luka', 'Zupan', 'luka.zupan@ucenec.si', 'test123', 'ucenec', NULL, NULL, 0),
(137, 'Petra', 'Mlakar', 'petra.mlakar@ucenec.si', 'test123', 'ucenec', NULL, NULL, 1),
(138, 'Nejc', 'Potočnik', 'nejc.potocnik@ucenec.si', 'test123', 'ucenec', NULL, NULL, 0),
(139, 'Maja', 'Vidmar', 'maja.vidmar@ucenec.si', 'test123', 'ucenec', NULL, NULL, 1),
(140, 'Jure', 'Bizjak', 'jure.bizjak@ucenec.si', 'test123', 'ucenec', NULL, NULL, 1),
(141, 'Klara', 'Golob', 'klara.golob@ucenec.si', 'test123', 'ucenec', NULL, NULL, 1),
(142, 'Žiga', 'Kranjc', 'ziga.kranjc@ucenec.si', 'test123', 'ucenec', NULL, NULL, 0);
...
--
ALTER TABLE `naloga`
  MODIFY `id_naloga` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `oddaja`
  MODIFY `id_oddaja` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `uporabnik`
  MODIFY `id_uporabnik` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=143;
